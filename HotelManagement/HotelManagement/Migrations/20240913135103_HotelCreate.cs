        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HousekeepingTasks_Users_AssignedStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    AssignedMaintenanceStaffId = table.Column<int>(type: "int", nullable: false),
                    IssueDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MaintenanceStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequestDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ScheduledDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReportedByStaffUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_Users_AssignedMaintenanceStaffId",
                        column: x => x.AssignedMaintenanceStaffId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_Users_ReportedByStaffUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_Users_GeneratedByStaffId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_AssignedMaintenanceStaffId",
                table: "MaintenanceRequests",
                column: "AssignedMaintenanceStaffId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_ReportedByStaffUserId",
                table: "MaintenanceRequests",

...
namespace HotelManagement.Controllers
{
    ...
    public class MaintenanceRequestsController : ControllerBase
    {
        ...
        {
            return await _context.MaintenanceRequests.Include(r=>r.Room).Include(u=>u.ReportedByStaff).Include(u=>u.AssignedMaintenanceStaff).ToListAsync();
        }
        ...
        {
            var maintenanceRequest = await _context.MaintenanceRequests.Include(u => u.ReportedByStaff)
                .Include(u => u.AssignedMaintenanceStaff).FirstOrDefaultAsync(r=>r.RequestId==id);

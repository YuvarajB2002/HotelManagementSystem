...
namespace HotelManagement.Controllers
{
    ...
    public class ReportsController : ControllerBase
    {
        ...
        [HttpGet("roomAvailabilityReport")]
        public async Task<IActionResult> GetRoomAvailabilityReport()
        {
            // Fetch all rooms
            var totalRooms = await _context.Rooms.CountAsync();

            // Fetch available rooms based on RoomStatus in the Rooms table
            var availableRooms = await _context.Rooms
                .Where(r => r.Status == "Available")  // Assuming RoomStatus stores values like "Available", "Not Available"
                .CountAsync();

            // Calculate unavailable rooms by subtracting available rooms from total rooms
            var unavailableRooms = totalRooms - availableRooms;
